...
def test_customer_viewer_allowed_parts(app):
    with app.app_context():
        ...
        Part(part_number="ASM-1001", revision="A", description="Root", attrs={"approvedby": "QA"}).save()
        Part(part_number="CMP-2002", revision="A", description="Child", attrs={"approvedby": "QA"}).save()
...
def test_supplier_viewer_allowed_parts(app):
    with app.app_context():
        ...
        Part(part_number="CMP-3000", revision="B", description="Ordered", attrs={"approvedby": "QA"}).save()
        Part(part_number="MAT-9999", revision="A", description="Child", attrs={"approvedby": "QA"}).save()
